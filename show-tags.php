...
exec('find "/media/usb/music/punk/"', $ffiles);
...
$iquery = sprintf("INSERT INTO songs (title, artist, band, album, track, set_part, year_released, publisher, bpm, genre, filename) VALUES ('%s', '%s', '%s', '%s', %s, '%s', %s, '%s', %s, '%s', '%s')", $title, $artist, $band, $album, $track, $set_part, $year_released, $publisher, $bpm, $genre, mysqli_real_escape_string($link, $filename)); 
